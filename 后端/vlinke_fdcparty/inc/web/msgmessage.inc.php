...
if ($op == "display") {
    ...
    $logdata = array('uniacid' => $_W['uniacid'], 'messageid' => $message['id'], 'userid' => 0, 'createtime' => time());
    ...
    $data = array('uniacid' => $_W['uniacid'], 'templateid' => $template['templateid'], 'templatename' => $template['templatename'], 'title' => "", 'dataarr' => $template['dataarr'], 'url' => "", 'miniprogram' => iserializer(array("appid" => "", "pagepath" => "")), 'createtime' => time());
    ...
    if (checksubmit('submit')) {
        ...
        $data = array('title' => trim($_GPC['title']), 'dataarr' => $dataarr, 'url' => trim($_GPC['url']), 'miniprogram' => iserializer($_GPC['miniprogram']));
