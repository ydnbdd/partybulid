...
if ($op == "display") {
    ...
    $data = array('mobile' => $mobile, 'sex' => intval($_GPC['sex']), 'nation' => trim($_GPC['nation']), 'birthday' => trim($_GPC['birthday']), 'origin' => trim($_GPC['origin']), 'education' => trim($_GPC['education']));
