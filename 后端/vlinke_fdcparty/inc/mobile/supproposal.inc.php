...
if ($op == "display") {
    ...
    $data = array('uniacid' => $_W['uniacid'], 'userid' => $user['id'], 'title' => trim($_GPC['title']), 'realname' => trim($_GPC['realname']), 'mobile' => trim($_GPC['mobile']), 'details' => trim($_GPC['details']), 'reply' => "", 'status' => 1, 'createtime' => time());
