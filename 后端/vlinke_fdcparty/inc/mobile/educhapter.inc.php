...
if ($op == "display") {
    ...
    if (empty($edulog)) {
        $edulog = array('uniacid' => $_W['uniacid'], 'userid' => $user['id'], 'lessonid' => $educhapter['lessonid'], 'chapterid' => $id, 'stutime' => 0, 'status' => 1, 'createtime' => time());
    ...
    $param['sharedesc'] = $educhapter['title'];
