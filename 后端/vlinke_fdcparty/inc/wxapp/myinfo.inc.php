...
if ($op == "display") {
    ...
    $this->result(0, '', array('user' => $user, 'ulevel' => $ulevelarr[$user['ulevel']], 'headpic' => $headpic));
} elseif ($op == "postinfo") {
    ...
    $data = array('mobile' => $mobile, 'birthday' => trim($_GPC['birthday']), 'sex' => intval($_GPC['sex']), 'origin' => trim($_GPC['origin']), 'nation' => trim($_GPC['nation']), 'education' => trim($_GPC['education']));
