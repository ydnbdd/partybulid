...
if ($op == "display") {
    ...
    $this->result(0, '', array('edulesson' => $edulesson, 'educate' => $educate));
} elseif ($op == "getmore") {
    $lessonid = intval($_GPC['lessonid']);
    ...
    $data = array('uniacid' => $_W['uniacid'], 'lessonid' => $lessonid, 'userid' => intval($_GPC['userid']), 'details' => $details, 'picall' => iserializer($picallarr), 'createtime' => time());
