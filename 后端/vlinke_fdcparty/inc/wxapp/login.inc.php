...
if ($op == "display") {
    ...
    $this->result(0, '', array('param' => $param));
} elseif ($op == 'getcode') {
    ...
    $data = array('wxappopenid' => trim($_W['openid']), 'wxappnickname' => trim($_GPC['nickname']), 'wxappheadimgurl' => trim($_GPC['headimgurl']));
    ...
    $data = array('wxappopenid' => "", 'wxappnickname' => "", 'wxappheadimgurl' => "");
