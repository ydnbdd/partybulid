...
if ($op == "display") {
    ...
    $data = array('uniacid' => $_W['uniacid'], 'cateid' => $cateid, 'userid' => intval($_GPC['userid']), 'title' => $title, 'details' => $details, 'picall' => iserializer($picallarr), 'vpath' => "", 'createtime' => time());
