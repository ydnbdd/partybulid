...
if ($op == "display") {
    ...
    $data = array('uniacid' => $_W['uniacid'], 'userid' => intval($_GPC['userid']), 'title' => trim($_GPC['title']), 'picall' => iserializer($picallarr), 'details' => trim($_GPC['details']), 'createtime' => time());
    ...
    $this->result(0, '', array('supreadily' => $supreadily));
}