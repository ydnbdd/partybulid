...
Page({
    ...
    getMore: function() {
        ...
        var e = a.data.article.id, i = a.data.pindex, n = a.data.psize;
    ...
    formSubmit: function(a) {
        ...
        if (0 == i.length) wx.showModal({
            ...
            var n = e.data.article.id, s = e.data.user.id, o = JSON.stringify(e.data.picall);
            t.default.post("artmessage", {
                op: "addmessage",
                articleid: n,
                userid: s,
    ...
    onLoad: function(a) {
        ...
        e.setData({
            ...
            param: n,
            user: s
        }), 0 == n.openart && null == s && wx.redirectTo({
            url: "../login/login"
        });
        var o = a.articleid;
        null == s || s.id;
        t.default.get("artmessage", {
            articleid: o
        }).then(function(t) {
            e.setData({
                article: t.article,
